        ...
        {items.length === 0 ? (
          ...
          <>
            <div className="space-y-4">
              {items.map((item) => (
                <div key={item.id} className="bg-white rounded-xl p-4 shadow-sm flex">
                  <img
                  ...
                  <div className="ml-4 flex-grow">
                    ...
                    <p className="text-gray-500 text-sm mt-1">{item.price.toFixed(2)} MAD</p>
            ...
            <div className="mt-8 bg-white rounded-xl p-4 shadow-sm">
              ...
              <button className="btn-primary w-full mt-4">{t("cart.checkout")}</button>
            </div>
          </>
        )}
      </div>
